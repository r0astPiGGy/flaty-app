...
import com.rodev.flatyapp.adapter.FlatViewAdapter;
...
import com.rodev.flatyapp.databinding.ActivityRegionBinding;
    ...
    private void initSearchBar() {
        ...
        searchBar.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String s) {
                ...
                flatViewAdapter.setShowFlatsPredicate(f -> f.getName().toLowerCase().contains(query));
                return true;
            }
